...
import com.panda.live.pandalive.LiveSingle.LiveSingleInteractionFragment;
import com.panda.live.pandalive.LiveSingle.NonInteractionFragment;
import com.panda.live.pandalive.R;

public class GroupInteractionDialogFragment extends DialogFragment{
    private ViewPager mViewpager;
    private GroupInteractionFragment mInteractionFragment;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_group_interaction_dialog, container, false);
    }
        ...
        mViewpager.setAdapter(new FragmentPagerAdapter(getChildFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                switch (position) {
                    ...
                    case 1:
                        return mInteractionFragment = new GroupInteractionFragment(); /*Quay lại phần giao diện tương tác*/
                }
                return null;
            }
            ...
            @Override
            public int getCount() {
                return 2; //Chỉ có 2 layer
            }
        });
        mViewpager.addOnPageChangeListener(new GroupInteractionDialogFragment.InteractionOnPageChangeListener());
