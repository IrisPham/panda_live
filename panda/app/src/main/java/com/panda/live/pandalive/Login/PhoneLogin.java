        ...
        mLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!phonenum.equals("") && !pass.equals("")) {
                    ...
                    if (phonenum.equals(PreferencesManager.getPhoneNum(mContext))
                            && pass.equals(PreferencesManager.getPass(mContext))) {
                        ...
                        PreferencesManager.saveUserInfo(getApplication(),
                                PreferencesManager.getNameLoginPhone(mContext),
                                phonenum, "none", "none", "none",
                                mFilePath, "none", "none",
                                "none", "none", 1000);

//                        PreferencesManager.setNameLoginPhone(mContext,
//                                PreferencesManager.getNameLoginPhone(mContext));
